...
import { BCMSMostCacheContent } from '../cache';
import { BCMSMostCacheContentInfo } from '..';
...
export interface BCMSMostCacheHandler {
  ...
  get: {
    /**
     * @ignore
     * Internal information for content cache policy.
     */
    contentInfo(): Promise<BCMSMostCacheContentInfo>;
    /**
  ...
  update: {
     ...
     * @ignore
     */
    contentInfo(data: BCMSMostCacheContentInfo): Promise<void>;
    /**
